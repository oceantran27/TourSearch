package com.example.flybooking.ui.screens.bookmark
...
class BookmarkTest {
    ...
    fun checkBookmark() {
        ...
        val bookingCard = device.findObject(By.desc("BookingHistory"))
        assert(bookingCard != null) {
            "Booking card should be displayed"
        }
    }
}